...
public class Stock {
    ...
    private void createStock(){
        ProductItem flour = new ProductItem(new Product("mąka pszenna 1kg", 2.5, 5908215500207L),100);
        ProductItem eggs =new ProductItem( new Product("jaja kurze 10szt", 12, 5908235955469L),150);
        ProductItem water = new ProductItem(new Product("woda niegazowana 1L",2.0, 5900635001364L),200);
        ProductItem milk = new ProductItem(new Product("mleko 1L", 4.0, 5900512320359L ),50);
        ProductItem butter =new ProductItem( new Product("masło 200g", 9.0, 5900820000257L),150);
